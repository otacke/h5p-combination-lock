...
export default class Util {
  ...
  /**
   * Wait for element to have stable height.
   * @param {HTMLElement} element Element to wait for.
   * @param {function} callback Function to call once element has stable height.
   */
  static waitForStableHeight(element, callback) {
